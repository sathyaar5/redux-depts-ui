describe("Department Management - Task", () => {
  ...
  it("should add a new department", () => {
    ...
    cy.get('input[placeholder="Department Name"]')
      .should("exist")
      .and("be.visible")
      .type("New Department");
    cy.get('input[placeholder="Manager Name"]')
      .should("exist")
      .and("be.visible")
      .type("Sathya");
  ...
  it("shows an error message when adding without department name and manager name", () => {
    ...
    cy.contains("Department name is required", { timeout: 5000 }).should(
      "exist",
    );
  });
